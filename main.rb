...
puts %q{ .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------. }
puts %q{| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |}
puts %q{| | ____   ____  | || |      __      | || | _____  _____ | || |   _____      | || |  _________   | || |    ______    | || |     ____     | |}
puts %q{| ||_  _| |_  _| | || |     /  \     | || ||_   _||_   _|| || |  |_   _|     | || | |  _   _  |  | || |   / ____ `.  | || |   .' __ '.   | |}
puts %q{| |  \ \   / /   | || |    / /\ \    | || |  | |    | |  | || |    | |       | || | |_/ | | \_|  | || |   `'  __) |  | || |   | (__) |   | |}
puts %q{| |   \ \ / /    | || |   / ____ \   | || |  | '    ' |  | || |    | |   _   | || |     | |      | || |   _  |__ '.  | || |   .`____'.   | |}
puts %q{| |    \ ' /     | || | _/ /    \ \_ | || |   \ `--' /   | || |   _| |__/ |  | || |    _| |_     | || |  | \____) |  | || |  | (____) |  | |}
puts %q{| |     \_/      | || ||____|  |____|| || |    `.__.'    | || |  |________|  | || |   |_____|    | || |   \______.'  | || |  `.______.'  | |}
puts %q{| |              | || |              | || |              | || |              | || |              | || |              | || |              | |}
puts %q{| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |}
puts %q{ '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' }
